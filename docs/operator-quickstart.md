# Operator Quickstart — Community Investigation Services

Shortest path from clone to a verified local dry-run for **ISIC 8030** (`cloud-itonami-isic-8030`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-8030.git
cd cloud-itonami-isic-8030
```
...
- Blueprint governor key: `private-investigation-governor`
- Likely source path: `src/**/private-investigation-governor.cljc`
